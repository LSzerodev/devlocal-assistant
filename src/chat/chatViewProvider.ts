...
import { messageRouter, type RouterDependencies } from './messageRouter';
...
export class ChatViewProvider implements vscode.WebviewViewProvider {
	...
	public async show(): Promise<void> {
		await this.ensureSideBarOnRight();
		await vscode.commands.executeCommand(`workbench.view.extension.${ChatViewProvider.containerId}`);
